...
- Python scripts for validation, branch orchestration, GitLab sync, discovery, and summary
...
- **GitLab create/sync split**: project bootstrap/protection and hourly branch reconciliation are handled in shared reusable workflows.
...
- Call the shared GitLab create workflow after branch/polling jobs.
- Use standalone `sync.yml` for hourly/manual org-wide GitLab reconciliation.
